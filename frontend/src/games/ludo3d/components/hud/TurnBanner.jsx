...
// Pawns.jsx); the legal-move chips here give the same choice as a clear,
// accessible list -- useful when several tokens are hard to tell apart at
// a glance, and a discoverable affordance for what's clickable. No
// instructional text -- kept intentionally quiet, the blinking pawns
